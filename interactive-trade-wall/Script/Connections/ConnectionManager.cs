...
public class ConnectionManager : MonoBehaviourPunCallbacks
{
    ...
    public void MaterialClickedinBook()
    {
        object[] content = new object[] { "material" }; // Array contains the target position and the IDs of the selected units
