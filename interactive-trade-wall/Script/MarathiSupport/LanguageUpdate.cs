...
public class LanguageUpdate:MonoBehaviour {
    ...
    #endregion
    //[ContextMenu("Set Reach Text Off")]
    //public void SetReachTextOff() {
    //    if (_languageText.richText) {
    //        _languageText.richText = true;
    //        _languageText.parseCtrlCharacters = true;
    //        Debug.Log($"[LanguageUpdate] Rich Text Disabled: {name}");
    //    }
    //}
